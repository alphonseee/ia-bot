    ...
    <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-6 text-center">
        ...
        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-[var(--bg-tertiary)] border border-[var(--border-color)] mb-8">
          ...
          <span className="text-sm text-[var(--text-secondary)]">Powered by AI + Evidence-Based Training</span>
        </div>
        ...
        <h1 className="text-5xl md:text-7xl font-bold tracking-tight mb-6">
          Your Personal
          <br />
          <span className="text-gradient">Strength Coach</span>
        </h1>

        <p className="text-xl text-[var(--text-secondary)] max-w-2xl mx-auto mb-10">
          Get personalized training programs, technique guidance, and evidence-based 
          advice from an AI coach trained on the best strength training resources.
        </p>
