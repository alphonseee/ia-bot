...
const questions = [
    ...
    {
        label: "Comment progresser au développé couché",
...
const steps = [
    ...
    {
        step: "02",
        title: "IronCoach analyse & structure",
...
const testimonials = [
    {
        ...
        result: "“En 6 semaines j’ai repris un rythme régulier et je progresse enfin au développé couché. Le fait de pouvoir poser des questions après chaque séance m’a vraiment aidé.”",
    },
    {
        name: "Sarah, 34 ans",
        goal: "Reprise après grossesse",
        result: "“IronCoach m’a proposé un plan progressif avec beaucoup de pédagogie. Je me sens encadrée sans pression, et je sais quoi faire à chaque séance.”",
    },
    {
        name: "Amine, 22 ans",
        goal: "Structurer son entraînement",
        result: "“Je faisais un peu tout au feeling. Maintenant j’ai un programme clair, avec des explications simples sur la technique et la progression.”",
    },
];
...
const faqs = [
    {
        ...
        answer: "Oui. Les réponses s’adaptent à ton niveau, à ton matériel, à ton objectif et au temps dont tu disposes. Plus tu donnes de contexte, plus IronCoach peut te guider précisément.",
    },
    {
        question: "Les sources sont-elles fiables ?",
        answer: "IronCoach s’appuie sur une sélection de ressources sérieuses (guides de musculation, articles de référence, consensus scientifiques) et affiche les sources utilisées pour chaque réponse importante.",
    },
    {
        question: "Quel matériel est requis ?",
        answer: "Aucun matériel n’est obligatoire. Tu peux demander un programme sans matériel, avec haltères, élastiques, salle de sport complète… IronCoach s’adapte à ce que tu as réellement.",
    },
    {
        question: "Et si j’ai une blessure ou une douleur ?",
        answer: "IronCoach peut t’aider à adapter ton entraînement (variantes, réduction de volume, etc.), mais ne remplace jamais un avis médical. En cas de douleur inhabituelle ou persistante, il faut consulter un professionnel de santé.",
    },
    {
        question: "C’est adapté aux débutants ?",
        answer: "Oui, c’est même une des priorités. Le ton reste simple, pédagogique et rassurant, avec des explications pas-à-pas pour les mouvements clés.",
    },
    {
        question: "C’est gratuit ou payant ?",
        answer: "Une première version est en préparation. Le modèle économique (gratuit / payant) sera annoncé bientôt, mais tu peux déjà tester le chat gratuitement pendant la phase de lancement.",
    },
];
...
export default function Home() {
    return (
        <main className="min-h-screen bg-transparent text-text relative">
            {/* Image de fond globale fixe - visible sur toute la page */}
            <div className="fixed inset-0 -z-10">
                <Image
                    src="/images/hero-ironcoach-gym.jpg"
                    alt="Coach sportif expliquant un exercice à un petit robot IA dans une salle de sport"
                    fill
                    priority
                    className="object-cover object-center opacity-60"
                />
                {/* Overlay global léger pour conserver le contraste */}
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 bg-bg/40 backdrop-blur-sm border-b border-border/60">
                <div className="max-w-5xl mx-auto px-6 py-4 flex items-center justify-between">
                    <Link
                        ...
                        aria-label="Retour à l’accueil IronCoach"
                    >
                        ...
                        <div className="flex-1">
                            ...
                            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight tracking-tight mb-4 text-white">
                                ...
                                <span className="block text-slate-200">
                                    en français, quand tu veux.
                                </span>
          </h1>
          
                            <p className="text-base md:text-lg text-slate-200/90 mb-8 max-w-xl">
                                Pose tes questions sur les programmes, la
                                technique, la nutrition ou la récupération.
                                IronCoach transforme ton contexte en
                                recommandations claires, structurées et
                                actionnables.
                            </p>
          ...
          >
            Commencer maintenant
                            ...
                            <p className="text-xs text-slate-300">
                                Pas un avis médical. Toujours consulter un
                                ...
                                <div className="space-y-3 text-xs md:text-sm">
                                    ...
                                    <div className="flex justify-end">
                                        <div className="max-w-[80%] rounded-2xl rounded-br-sm bg-accent text-white px-3 py-2 shadow-sm">
                                            <p>
                                                Je suis débutant, 3 séances par
                                                semaine et accès à une salle. Tu
                                                peux me proposer un programme ?
                                            </p>
                                        </div>
                                    </div>
                                    ...
                                    <div className="flex justify-start">
                                        <div className="max-w-[85%] rounded-2xl rounded-bl-sm bg-bg-alt/80 backdrop-blur-sm px-3 py-2 border border-border/80">
                                            ...
                                            <p className="text-text-muted text-[11px] md:text-xs">
                                                On part sur un full body
                                                3x/semaine, avec focus sur les
                                                mouvements de base et une
                                                progression simple.
                                            </p>
                                        </div>
                                    </div>
                                    ...
                                    <div className="mt-2 rounded-xl border border-border/80 bg-bg/90 px-3 py-2">
                                        ...
                                        <ul className="space-y-0.5 text-[11px] text-text-muted">
                                            <li>
                                                • Guide pratique de musculation
                                                – Delavier &amp; Gundill
                                            </li>
                                            <li>
                                                • Recommandations ACSM pour
                                                l’entraînement de force
                                            </li>
                                            <li>
                                                • Articles de revue sur la
            ...
            <section
                id="demo"
                className="py-16 px-6 border-t border-border bg-bg-alt/20 backdrop-blur-sm"
            >
                    ...
                    <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-8">
                        <div>
                            ...
                            <p className="text-2xl md:text-3xl font-bold">
                                À quoi ressemble une réponse d’IronCoach ?
                            </p>
                        </div>
                        <p className="text-sm text-text-muted max-w-sm">
                            Un exemple concret de question qu’un débutant
                            pourrait poser, avec une réponse structurée, un mini
                            programme sur 3 jours et des sources affichées.
                        </p>
                    </div>
                            ...
                            <div className="space-y-5 text-sm">
                                <div>
                                    ...
                                    <div className="rounded-xl border border-border bg-bg-alt/70 px-3 py-2">
                                        Je suis débutant, 3 séances par semaine,
                                        1h max par séance. J’ai accès à une
                                        salle classique. Tu peux me faire un
                                    ...
                                    <div className="space-y-3">
                                        <div className="rounded-xl border border-border bg-bg-alt px-3 py-3">
                                            ...
                                            <p className="text-text-muted text-xs">
                                                • Fréquence : 3 séances /
                                                semaine (ex : lundi, mercredi,
                                                vendredi)
                                                <br />
                                                • Format : full body orienté
                                                mouvements de base
                                                <br />• Objectif : apprendre la
                                                technique, créer une base de
                                                force, stimuler tout le corps
                                                3x/semaine.
                                            </p>
                                        </div>
                                        <div className="rounded-xl border border-border bg-bg-alt px-3 py-3">
                                            <p className="font-medium mb-1">
                                                2. Règles simples de progression
                                            </p>
                                            <p className="text-text-muted text-xs">
                                                • Choisis une plage de
                                                répétitions (ex : 8–10 reps)
                                                <br />
                                                • Quand tu fais 10 reps
                                                facilement sur toutes les
                                                séries, augmente la charge de
                                                2,5 kg la prochaine séance
                                                <br />• Si tu es fatigué ou que
                                                la technique se dégrade, reste à
                                                la même charge ou diminue
                                                légèrement.
                                            </p>
                                        </div>
                                    </div>
                        ...
                        <div className="space-y-4">
                            <div className="rounded-2xl border border-border bg-bg/80 backdrop-blur-sm p-4 md:p-5">
                                ...
                                <div className="space-y-3 text-xs">
                                    ...
                                    <div className="rounded-xl border border-border bg-bg-alt/70 px-3 py-2">
                                        ...
                                        <p className="text-text-muted">
                                            Soulevé de terre jambes tendues,
                                            développé militaire, tirage
                                            vertical, hip thrust, planche
                                            latérale.
                                        </p>
                                    </div>
                                    <div className="rounded-xl border border-border bg-bg-alt/70 px-3 py-2">
                                        <p className="font-semibold mb-1">
                                            Jour 3 – Technique & volume
                                        </p>
                                        <p className="text-text-muted">
                                            Variantes plus légères des
                                            mouvements principaux + travail de
                                            gainage et épaules.
              </p>
            </div>
                                </div>
                            ...
                            <div className="rounded-2xl border border-border bg-bg/80 backdrop-blur-sm p-4">
                                ...
                                <ul className="space-y-1 text-xs text-text-muted">
                                    <li>
                                        • Recommandations ACSM – résistance et
                                        hypertrophie
                                    </li>
                                    <li>
                                        • Méta-analyses sur la fréquence
                                        d’entraînement par groupe musculaire
                                    </li>
                                    <li>
                                        • Guides techniques sur squat /
                            ...
                            <p className="text-[11px] text-text-muted">
                                Les exemples ci-dessus sont illustratifs. En
                                situation réelle, IronCoach adaptera le contenu
                                à ton propre contexte.
              </p>
            </div>
          </div>
        </div>
                ...
                <div className="max-w-5xl mx-auto">
                    <div className="flex items-center justify-between gap-4 mb-6">
                        ...
                        <p className="hidden md:block text-sm text-text-muted max-w-xs">
                            Clique sur une suggestion pour l’envoyer directement
                            dans le chat IronCoach.
                        </p>
                    </div>
                    ...
                    <p className="mt-4 text-xs text-text-muted">
                        Tu peux aussi simplement décrire ta situation (“je
                        m’entraîne depuis 6 mois, je stagne au squat…”) et
                        laisser IronCoach te poser les bonnes questions.
                    </p>
                </div>
            </section>
                                    ...
                                    <div className="rounded-2xl border border-border bg-bg/80 backdrop-blur-sm p-4 flex-1">
                                        ...
                                        {index === 0 && (
                                            <p className="mt-2 text-xs text-text-muted/80">
                                                Exemple : “Je m’entraîne 2 fois
                                                par semaine, j’ai des haltères
                                                chez moi, je veux surtout
            ...
            <section className="py-16 px-6 border-t backdrop-blur-sm border-border">
                <div className="max-w-5xl mx-auto">
                    <div className="mb-8">
                        ...
                        <p className="text-2xl md:text-3xl font-bold">
                            Résultats réalistes, sans bullshit
                        </p>
                    </div>
                    ...
                    <div className="relative overflow-hidden rounded-3xl border border-accent/40 bg-gradient-to-r from-accent/15 via-accent/5 to-bg-alt/60 px-6 py-8 md:px-8 md:py-10 shadow-[0_18px_60px_rgba(0,0,0,0.65)]">
                        ...
                        <div className="relative max-w-xl">
                            ...
                            <h2 className="text-2xl md:text-3xl font-bold mb-3">
                                Ouvre le chat et construis ton prochain cycle
                                d’entraînement.
                            </h2>
                            <p className="text-sm md:text-base text-text-muted mb-6">
                                Explique ta situation en quelques phrases, et
                                laisse IronCoach te proposer un plan clair, avec
                                des recommandations techniques, nutrition et
                                récupération.
                            </p>
                            ...
                            <div className="flex flex-col sm:flex-row gap-3 items-start sm:items-center">
                                ...
                                <p className="text-[11px] text-text-muted max-w-xs">
                                    IronCoach ne remplace pas un médecin, un
                                    kiné ou un coach en présentiel. Utilise les
                                    réponses comme un support, pas comme un
                                    diagnostic.
                                </p>
                            </div>
                        </div>
            ...
            <footer className="py-8 px-6 border-t border-border bg-bg-alt/20 backdrop-blur-sm">
                <div className="max-w-5xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-text-muted">
                    <div className="flex items-center gap-2">
                        <span className="font-medium">IronCoach © 2026</span>
                        <span className="hidden sm:inline-block">•</span>
                        <span>
                            Projet en évolution, contenu susceptible de changer.
                        </span>
                    </div>
